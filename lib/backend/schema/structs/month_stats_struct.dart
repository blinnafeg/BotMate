...
class MonthStatsStruct extends BaseStruct {
  MonthStatsStruct({
  ...
  static MonthStatsStruct fromMap(Map<String, dynamic> data) =>
      MonthStatsStruct(
  ...
  static MonthStatsStruct? maybeFromMap(dynamic data) => data is Map
      ? MonthStatsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MonthStatsStruct fromSerializableMap(Map<String, dynamic> data) =>
      MonthStatsStruct(
  ...
  @override
  String toString() => 'MonthStatsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is MonthStatsStruct &&
...
MonthStatsStruct createMonthStatsStruct({
  int? totalAppointments,
  int? pendingCount,
  int? confirmedCount,
  int? cancelledCount,
