...
class MonthForwardStatsStruct extends BaseStruct {
  MonthForwardStatsStruct({
  ...
  static MonthForwardStatsStruct fromMap(Map<String, dynamic> data) =>
      MonthForwardStatsStruct(
  ...
  static MonthForwardStatsStruct? maybeFromMap(dynamic data) => data is Map
      ? MonthForwardStatsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MonthForwardStatsStruct fromSerializableMap(
  ...
  @override
  String toString() => 'MonthForwardStatsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is MonthForwardStatsStruct &&
...
MonthForwardStatsStruct createMonthForwardStatsStruct({
  int? totalAppointments,
  int? pendingCount,
  int? confirmedCount,
  int? cancelledCount,
